 ...
 *
 * 실측 필드(항상): 제목 · 요약 · 생성 시각. 제목은 기존 상세(/report/{publicId}) 링크.
 * mock 메타(item.mock 있을 때만): 유형 배지(.kbadge) · 공개 배지(PUBLIC) · **대표 태그 1개**.
        ...
        >
          {mock && (
            <>
              ...
              <span
                className={`inline-flex h-[22px] items-center rounded-full border px-2 text-[10.5px] font-semibold whitespace-nowrap ${
